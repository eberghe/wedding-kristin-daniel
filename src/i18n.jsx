...
const translations = {
  de: {
    ...
    faq_5_a: 'Festlich-elegant — stilvoll und feierlich. Kleider, Anzüge, Hosenanzüge in gedämpften Farben und Grüntönen sind willkommen. Bitte kein Weiß (das gehört der Braut) und kein allzu lässiges Outfit.',
    ...
    dresscode_intro: 'Wir wünschen uns festlich-elegante Kleidung — stilvoll und feierlich. Kleider, Anzüge, Hosenanzüge in gedämpften Farben und Grüntönen sind willkommen. Bitte kein Weiß (das gehört der Braut) und nichts zu Lässiges.',
  ...
  en: {
    ...
    faq_5_a: 'Formal elegant — stylish and celebratory. Dresses, suits, trouser suits in muted tones and greens are welcome. Please no white (that belongs to the bride) and nothing too casual.',
    ...
    dresscode_intro: 'We ask for formal elegant attire — stylish and celebratory. Dresses, suits, and trouser suits in muted tones and greens are very welcome. Please no white (that belongs to the bride) and nothing too casual.',
